...
void main() {
  testWidgets('Editor Core Interaction Test', (WidgetTester tester) async {
    ...
    expect(textLayer1.isSelected, true, reason: "Layer should be selected after tap");
    ...
    expect(textLayer1.position.dx, greaterThan(1.0), reason: "Layer X position should update after drag");
    expect(textLayer1.position.dy, greaterThan(1.0), reason: "Layer Y position should update after drag");
